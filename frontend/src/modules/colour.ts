...
import { blockCodeGenerators } from "../compiler/blockCodeGenerator";
...
blockCodeGenerators.colour_picker = (block, buffer, ctx) => {
...
blockCodeGenerators.colour_random = (block, buffer, ctx) => {
    return {
...
blockCodeGenerators.colour_rgb = (block, buffer, ctx) => {
...
blockCodeGenerators.colour_blend = (block, buffer, ctx) => {
    return {
...
Blockly.Blocks['colour_get_channel'] = {
    init: function (this: Blockly.BlockSvg) {
        this.appendValueInput("VALUE")
            .setCheck("Colour")
            .appendField("Get Colour Channel")
            .appendField(new Blockly.FieldDropdown([['r', 'R'], ['g', 'G'], ['b', 'B']]) as Blockly.Field<string | undefined>, "CHANNEL");
...
blockCodeGenerators.colour_get_channel = (block, buffer, ctx) => {
