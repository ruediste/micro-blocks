...
registerBlock('math_number_property', {
    codeGenerator: (block, buffer, ctx) => {
...
registerBlock('math_map_temperature', {
    codeGenerator: (block, buffer, ctx) => {
